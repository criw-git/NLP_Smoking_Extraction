...
seed = 97
# Binary Tests
# y_pred, metrics, model_infos = LSTM_Bidir(X_train_b, y_train_b, X_test_b, y_test_b, word_index_eff, embedding_matrix_w2v_eff, max_len_eff, seed, False)
# avg_metrics = findAverage(metrics)
# print("Average Scores")
# print(avg_metrics)

# Categorical Tests
y_pred, metrics, model_infos = LSTM_Bidir(X_train_c, y_train_c, X_test_c, y_test_c, word_index_eff, embedding_matrix_GNV_eff, max_len_eff, seed, True)
avg_metrics = findAverage(metrics)
print("Average Scores")
print(avg_metrics)